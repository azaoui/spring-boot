...
### Filter trace for actuator httptrace  
...
public class TraceRequestFilter extends HttpTraceFilter {
    //do not trace for those paths 
    private static String[] excludedPaths = new String[]{"/api/**","/", "/app/**","/actuator/**"};
...
### Secure the Actuator endpoints with spring security
